...
import net.feilue.IMCode.service.network.udp.MBUDPClientInboundHandler;
import net.feilue.IMCode.service.network.udp.MBUDPServerChannel;
...
public class GatewayUDP extends Gateway
{
     ...
     * 作为全局变量的目的，当前仅用于关闭服务器时来释放此连接池对应的资源，别无它用。
     * 
 	 * @see net.feilue.IMCode.server#startup()
 	 */
 	 ...
 	 * 
 	 * @see net.feilue.IMCode.server#shutdown()
 	 */
...
//		__workerGroup4Netty.shutdownGracefully();
	 ...
	 * 
	 * @return handler链对象
	 * @see net.feilue.IMCode.service.network.udp.MBUDPClientInboundHandler
