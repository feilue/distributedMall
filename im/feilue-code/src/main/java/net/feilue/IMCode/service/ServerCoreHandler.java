...
import net.feilue.IMCode.service.event.MessageQoSEventListenerS2C;
import net.feilue.IMCode.service.event.ServerEventListener;
import net.feilue.IMCode.service.network.Gateway;
import net.feilue.IMCode.service.processor.BridgeProcessor;
import net.feilue.IMCode.service.processor.LogicProcessor;
import net.feilue.IMCode.service.processor.OnlineProcessor;
import net.feilue.IMCode.service.protocal.Protocal;
import net.feilue.IMCode.service.protocal.ProtocalType;
import net.feilue.IMCode.service.utils.LocalSendHelper;
import net.feilue.IMCode.service.utils.ServerToolKits;
 ...
 * @version 1.0
 * @since 3.1
 * @see net.feilue.IMCode.service.processor.LogicProcessor
 * @see net.feilue.IMCode.service.processor.BridgeProcessor
 * @see net.feilue.IMCode.service.processor.OnlineProcessor
 */
public class ServerCoreHandler
{
     ...
     * 
     * @see ServerLauncher#bridgeEnabled
     * @see net.feilue.IMCode.service.processor.BridgeProcessor#start()
     */
     ...
     * <p>
     * 本方法将被 {@link net.feilue.IMCode.service.network.tcp.MBTCPClientInboundHandler#exceptionCaught(
     ...
     * @see net.feilue.IMCode.service.network.tcp.MBTCPClientInboundHandler#exceptionCaught(io.netty.channel.ChannelHandlerContext, Throwable)
     */
     ...
     * <p>
     * 本方法将被 {@link net.feilue.IMCode.service.network.tcp.MBTCPClientInboundHandler#channelRead0(
     ...
     * @see net.feilue.IMCode.service.processor.LogicProcessor
     * @see net.feilue.IMCode.service.network.tcp.MBTCPClientInboundHandler#channelRead0(io.netty.channel.ChannelHandlerContext, ByteBuf)
     */
...
//    	Protocal pFromClient = ServerToolKits.fromIOBuffer(bytebuf);
     ...
     * </ul>
     * <p>
     * 本方法将被 {@link net.feilue.IMCode.service.network.tcp.MBTCPClientInboundHandler#channelInactive(
     ...
     * @see net.feilue.IMCode.service.processor.OnlineProcessor#removeUser(int)
     * @see net.feilue.IMCode.service.event.ServerEventListener#onUserLogoutAction_CallBack(int, Object)
     * @see net.feilue.IMCode.service.network.tcp.MBTCPClientInboundHandler#channelInactive(io.netty.channel.ChannelHandlerContext)
     */
     ...
     * 默认情况下，本方法什么也没做。
     * <p>
     * 本方法将被 {@link net.feilue.IMCode.service.network.tcp.MBTCPClientInboundHandler#channelActive(
     * io.netty.channel.ChannelHandlerContext)}调用，以便接受Netty中客户端“会话”建立通知。
     * 
     * @param session 建立的Netty"会话"对象引用
     * @see net.feilue.IMCode.service.network.tcp.MBTCPClientInboundHandler#channelActive(io.netty.channel.ChannelHandlerContext)
     */
