 ...
 */
package net.feilue.IMCode.service.qos;
 ...
 * @version 2.1
 * @see net.feilue.IMCode.service.qos.QoS4ReciveDaemonC2S
 * @see net.feilue.IMCode.service.event.MessageQoSEventListenerS2C
 */
