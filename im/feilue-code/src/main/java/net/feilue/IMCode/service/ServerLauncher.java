...
import net.feilue.IMCode.service.network.GatewayTCP;
import net.feilue.IMCode.service.network.GatewayUDP;
import net.feilue.IMCode.service.network.GatewayWebsocket;
import net.feilue.IMCode.service.qos.QoS4ReciveDaemonC2S;
import net.feilue.IMCode.service.qos.QoS4SendDaemonS2C;
...
//	public static String appKey = null;
     ...
     * @see #initListeners()
     * @see #initGateways()
     * @see net.feilue.IMCode.service.qos.QoS4ReciveDaemonC2S#startup()
     * @see net.feilue.IMCode.service.qos.QoS4SendDaemonS2C#startup(boolean)
...
//    			QoS4SendDaemonB2C.getInstance().startup(true).setServerLauncher(this);
     ...
     * @see net.feilue.IMCode.service.qos.QoS4ReciveDaemonC2S#stop()
     * @see net.feilue.IMCode.service.qos.QoS4SendDaemonS2C#stop()
     * @see net.feilue.IMCode.service.bridge.QoS4ReciveDaemonC2B#stop()
     * @see net.feilue.IMCode.service.bridge.QoS4SendDaemonB2C#stop()
     */
