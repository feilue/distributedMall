 ...
 */
package net.feilue.IMCode.service.network;
...
import net.feilue.IMCode.service.ServerCoreHandler;
import net.feilue.IMCode.service.network.websocket.MBWebsocketClientInboundHandler;
...
public class GatewayWebsocket extends Gateway
{
	 ...
	 * <p>
	 * 请在 {@link net.feilue.IMCode.service.ServerLauncher#startup()}方法被调用前被设置，否则将不起效.
	 */
	 ...
	 * 请在 {@link net.feilue.IMCode.service.ServerLauncher#startup()}方法被调用前被设置，否则将不起效.
	 * 
	 * @see net.feilue.IMCode.service.utils.ServerToolKits#setSenseModeTCP(net.feilue.IMCode.service.utils.ServerToolKits.SenseModeTCP)
     */
     ...
     * 
     * @see net.feilue.IMCode.service.ServerLauncher#startup()
     */
     ...
     * 
 	 ...
 	 * 
 	 * @see net.feilue.IMCode.service.ServerLauncher#shutdown()
 	 */
     ...
     * 初始化 Netty的服务辅助启动类。
     * 
     * @see net.feilue.IMCode.service.ServerLauncher#initGateways()
     */
 	@Override
	 ...
	 * @return handler链对象
	 * @see #init()
	 * @see net.feilue.IMCode.service.network.tcp.MBTCPClientInboundHandler
