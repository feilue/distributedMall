 ...
 */
package net.feilue.IMCode.service.utils;
...
import net.feilue.IMCode.service.ServerLauncher;
...
import net.feilue.IMCode.service.protocal.ErrorCode;
import net.feilue.IMCode.service.protocal.Protocal;
import net.feilue.IMCode.service.protocal.ProtocalFactory;
import net.feilue.IMCode.service.protocal.s.PKickoutInfo;
 ...
 * <p>
 * <b>注意：</b>如果未开通与Web版的互通（参见： {@link net.feilue.IMCode.service.ServerLauncher#bridgeEnabled} ）
 * ，则服务端消息发送建议使用本类，否则请使用 {@link GlobalSendHelper} 。
 * 
 * @author Jack Jiang(http://www.52im.net/thread-2792-1-1.html)
 * @version 1.0
 * @since 3.1
 * @see net.feilue.IMCode.service.ServerLauncher#bridgeEnabled
 */
